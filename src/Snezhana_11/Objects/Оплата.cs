...
namespace IIS.Snezhana_11
{
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Snezhana_11.Способ1 fСпособ;
        
        private System.DateTime fДата;
        
        private double fСумма;
        
        private IIS.Snezhana_11.Заказ fЗаказ;
        ...
        public virtual IIS.Snezhana_11.Способ1 Способ
        {
            get
            {
                ...
                IIS.Snezhana_11.Способ1 result = this.fСпособ;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Snezhana_11.Заказ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        public virtual IIS.Snezhana_11.Заказ Заказ
        {
            get
            {
                ...
                IIS.Snezhana_11.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Snezhana_11.Оплата));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОплата : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Snezhana_11.DetailArrayOfОплата members)

        // *** End programmer edit section *** (IIS.Snezhana_11.DetailArrayOfОплата members)
        ...
        /// </summary>
        public DetailArrayOfОплата(IIS.Snezhana_11.Заказ fЗаказ) : 
                base(typeof(Оплата), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.Snezhana_11.Оплата this[int index]
        {
            get
            {
                return ((IIS.Snezhana_11.Оплата)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Snezhana_11.Оплата dataobject)
        {
