...
namespace IIS.Snezhana_11
{
    ...
    public class Товар : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Snezhana_11.Производитель fПроизводитель;
        
        private IIS.Snezhana_11.Поставщик fПоставщик;
        ...
        [PropertyStorage(new string[] {
                "Поставщик"})]
        [NotNull()]
        public virtual IIS.Snezhana_11.Поставщик Поставщик
        {
            get
            {
                ...
                IIS.Snezhana_11.Поставщик result = this.fПоставщик;
        ...
        [PropertyStorage(new string[] {
                "Производитель"})]
        [NotNull()]
        public virtual IIS.Snezhana_11.Производитель Производитель
        {
            get
            {
                ...
                IIS.Snezhana_11.Производитель result = this.fПроизводитель;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварE", typeof(IIS.Snezhana_11.Товар));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварL", typeof(IIS.Snezhana_11.Товар));
                }
            }
        }
    }
